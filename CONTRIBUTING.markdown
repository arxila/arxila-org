Contributing to ARXILA: Terms and Conditions
============================================

------------------------------------------------------------------------------


Do you want to contribute your work to ARXILA? Well, then first and most important: **THANK YOU!**
...
**Important**: submitting any contributions to the ARXILA project implies your **full acceptance of these terms**,
including the *"ARXILA Individual Contributor License Agreement"* detailed at the end.
...
First of all, **talk to the project members** (an email or GitHub discussion should do) about
...
How will your relation with the ARXILA project be?
--------------------------------------------------
...
### Detailed Java code quality standards:
  ...
  - All `.java` files must include the standard ARXILA copyright header.
...
Note the following only applies to documentation/articles meant to be published at the ARXILA website.
  ...
  - Project members may edit and make small changes to your texts --of which you will be informed-- before 
    publishing them.
  - Format and visual styles must adhere to the ARXILA website standards, of which you will be informed
...
All ARXILA software is distributed under the **Apache License 2.0** open source license, and your contributions
...
explained in this page, and that it both authorises your contribution to ARXILA and states that will
never claim any kind of rights over it.



ARXILA Individual Contributor License Agreement
-----------------------------------------------

This contributor agreement ("Agreement") documents the rights granted by contributors to the ARXILA Project.

This is a legally binding document, so please read it carefully before agreeing to it. The Agreement
may cover more than one software project managed by ARXILA.

###1. Definitions

  * _"ARXILA"_ means the "ARXILA Project organization and members".
  * _"You"_ means the individual who submits a Contribution to ARXILA.
  * _"Contribution"_ means any work of authorship that is submitted by you to ARXILA in which you own
  ...
  * _"Material"_ means the work of authorship which is made available by ARXILA to third parties. When
    ...
    in the Material.
  * _"Submit"_ means any form of electronic, verbal, or written communication sent to ARXILA or its
    representatives, including but not limited to electronic mailing lists, source code control systems,
    and issue tracking systems that are managed by, or on behalf of, ARXILA for the purpose of discussing
  ...
  * _"Submission Date"_ means the date on which you submit a Contribution to ARXILA.
  * _"Effective Date"_ means the date you execute this agreement or the date You first submit a
    Contribution to ARXILA, whichever is earlier.
...
####2.1. Copyright License
  ...
  * (b) To the maximum extent permitted by the relevant law, you grant to ARXILA a perpetual, worldwide,
...
own, control or have the right to grant, now or in the future, you grant to ARXILA a perpetual, worldwide,
...
As a condition on the grant of rights in Sections 2.1 and 2.2, ARXILA agrees to license the Contribution only
...
to assert such moral rights against ARXILA or its successors in interest, or any of our licensees, either
direct or indirect.


####2.5 ARXILA Rights

You acknowledge that ARXILA is not obligated to use your Contribution as part of the
Material and may decide to include any Contributions ARXILA considers appropriate.
...
FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT ARE EXPRESSLY DISCLAIMED BY YOU TO ARXILA AND BY
ARXILA TO YOU. TO THE EXTENT THAT ANY SUCH WARRANTIES CANNOT BE DISCLAIMED, SUCH WARRANTY IS LIMITED IN
...
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL YOU OR ARXILA BE LIABLE FOR ANY LOSS OF
...
###6. Miscellaneous
  ...
  * 6.2 This Agreement sets out the entire agreement between you and ARXILA for your Contributions to ARXILA
        and overrides all other agreements or understandings.
  * 6.3 If You or ARXILA assign the rights or obligations received through this Agreement to a third party, as a
